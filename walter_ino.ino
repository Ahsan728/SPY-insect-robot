...
void setup() {
  ...
  SERVO_front_left.attach(3);   // ***Set up front-left servo's signal pin on arduino.
  SERVO_front_right.attach(4);  // ***Set up front-right servo's signal pin on arduino.
  SERVO_back_left.attach(5);    // ***Set up back-left servo's signal pin on arduino.
  SERVO_back_right.attach(6);   // ***Set up back-right servo's signal pin on arduino.
